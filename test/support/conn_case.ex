defmodule StartupGameWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use StartupGameWeb.ConnCase, async: true`, although
  ...
  def log_in_user(conn, user) do
    token = StartupGame.Accounts.generate_user_session_token(user)
