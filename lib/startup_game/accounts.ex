defmodule StartupGame.Accounts do
  @moduledoc """
  ...
  alias StartupGame.Accounts.{User, UserToken, UserNotifier}
  ...
  @doc """
  Returns an `%Ecto.Changeset{}` for changing the user email and username.
