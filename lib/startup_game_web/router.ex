defmodule StartupGameWeb.Router do
  ...
  scope "/admin", StartupGameWeb do
    ...
    live_session :admin_authenticated,
      ...
      live "/training_games/:id/play", Admin.TrainingGameLive.Play, :play
  ...
  if Application.compile_env(:startup_game, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: StartupGameWeb.Telemetry
  ...
  scope "/", StartupGameWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{StartupGameWeb.UserAuth, :redirect_if_user_is_authenticated}] do
